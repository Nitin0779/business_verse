"""
BusinessVerse - Backend Database Connector Utility
...
def get_engine():
    """Create and return a SQLAlchemy engine (cached globally)."""
    ...
    if db_type == "sqlite":
        # SQLite db path relative to project structure
    ...
    _CACHED_ENGINE = create_engine(url, echo=False, pool_pre_ping=True)
    return _CACHED_ENGINE
